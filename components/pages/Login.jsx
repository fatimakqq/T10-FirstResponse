...
const LoginCard = () => {
    ...
    return (
        ...
        <section className='w-3/4 mx-auto flex flex-col'>
            <div className="title">
                <h1 className='text-white text-4xl font-majorMonoDisplay font-bold py-4'>Sign In</h1>
            </div>
            ...
            <form className='flex flex-col gap-5' onSubmit={formik.handleSubmit}>
                ...
                <div class="flex items-center w-full h-1 my-4">
                  <hr class=" bg-white mt-4 mb=4 w-1/2 bg-black border-none mr-3"/>
                  <span class="font-bold font-manjari mt-3">or</span>
                  <hr class="bg-white mt-4 mb=4 w-1/2 bg-black border-none ml-3"/>
                </div>
                <div className="input-button">
                ...
                <div class="flex justify-center">
                  <p class="mt-12 font-manjari ">Don't have an account?<a className="ml-2 text-green-600 " href="#" onClick={handleClick}>Create a new one</a></p>
                </div>
            </form>
